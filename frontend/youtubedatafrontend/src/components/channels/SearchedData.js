...
const columns = [
  ...
  {
    title: "Total Views",
    dataIndex: "Channel_views",
  },
  {
    title: "Seacrh Term",
    dataIndex: "Channel_query",
  },
  {
    title: "City",
    dataIndex: "Channel_city",
  },
];
...
const title = () => "Youtube Data using React";
const showHeader = true;
const footer = () => "Here is footer";
const pagination = { position: "bottom" };

export class SearchedData extends Component {
  state = {
    bordered: false,
    loading: false,
    pagination,
  ...
  // }
  render() {
    const data = this.props.ytubeData.data;
    console.log(data);
